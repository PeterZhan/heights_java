...
public class SaveWinGuardRec extends BaseAgiScript {
	...
	public void service(AgiRequest arg0, AgiChannel arg1) throws AgiException {
		...
		String fname = getVariable("WinGuardRec") + ".WAV";
	...
	//	opts[4] = opt;
		...
		try {
			ASTPORTAL.generalCommand(cmd, opts, fullname, "WnGuard.nsf");
		} catch (IOException e) {
