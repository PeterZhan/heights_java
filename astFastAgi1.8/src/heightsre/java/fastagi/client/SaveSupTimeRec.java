...
public class SaveSupTimeRec extends BaseAgiScript {
	...
	public void service(AgiRequest arg0, AgiChannel arg1) throws AgiException {
		...
		String fname = getVariable("superRec") + ".WAV";
	...
	//	opts[4] = opt;
		...
		try {
			ASTPORTAL.generalCommand(cmd, opts, fullname, "TimeShet.nsf");
		} catch (IOException e) {
