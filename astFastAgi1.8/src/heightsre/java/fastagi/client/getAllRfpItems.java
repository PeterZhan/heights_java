...
public class getAllRfpItems extends BaseAgiScript {

	@Override
	public void service(AgiRequest arg0, AgiChannel arg1) throws AgiException {
		// TODO Auto-generated method stub

		String cmd = "GETALLRFPITEMS";
		...
		setVariable("itemnum", typeNum);
		
		String jtPrompt = "";
		
		for (int i=1; i<=iTypeNum; i++)
		{
			setVariable("it" + i, res[i]);
