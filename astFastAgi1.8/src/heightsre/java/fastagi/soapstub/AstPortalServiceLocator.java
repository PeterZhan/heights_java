...
public class AstPortalServiceLocator extends org.apache.axis.client.Service implements heightsre.java.fastagi.soapstub.AstPortalService {
    ...
    private java.lang.String Domino_address = "https://www.heightsre.com:443/Examples/Test/heightscalls.nsf/AstPortal?OpenWebService";
    ...
    public heightsre.java.fastagi.soapstub.AstPortal getDomino() throws javax.xml.rpc.ServiceException {
    ...
    public heightsre.java.fastagi.soapstub.AstPortal getDomino(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            heightsre.java.fastagi.soapstub.DominoSoapBindingStub _stub = new heightsre.java.fastagi.soapstub.DominoSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (heightsre.java.fastagi.soapstub.AstPortal.class.isAssignableFrom(serviceEndpointInterface)) {
                heightsre.java.fastagi.soapstub.DominoSoapBindingStub _stub = new heightsre.java.fastagi.soapstub.DominoSoapBindingStub(new java.net.URL(Domino_address), this);
                _stub.setPortName(getDominoWSDDServiceName());
                return _stub;
            }
        }
