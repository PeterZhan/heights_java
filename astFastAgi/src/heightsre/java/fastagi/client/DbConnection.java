...
public class DbConnection {
   ...
   /*     if (drivers != null) 
 	...
 	//  System.setProperty("jdbc.drivers", drivers);
        ...
        String url = cfg.url;  // mysql connection url
        String username = cfg.dbusername;  // mysql connection username
        String password = cfg.dbpassword;  // mysql connection password
   ...
   //     in = null;
        ...
        String logFile            = "/var/javalib/DbConBroker.log";  // log file
