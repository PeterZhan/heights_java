...
public class getAllRfpActs extends BaseAgiScript {

	@Override
	public void service(AgiRequest arg0, AgiChannel arg1) throws AgiException {
		// TODO Auto-generated method stub

		String cmd = "GETALLRFPACTS";
		...
		setVariable("actnum", typeNum);
		
		String jtPrompt = "";
		
		for (int i=1; i<=iTypeNum; i++)
		{
			setVariable("at" + i, res[i]);
