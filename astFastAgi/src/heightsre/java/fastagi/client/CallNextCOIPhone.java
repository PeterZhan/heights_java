...
public class CallNextCOIPhone extends BaseAgiScript {
	...
	private String callTenantForCOI(String[] options)
	{
		String res = "OK";
		...
		String context1 = "callcomcellCOI";
		String context2 = "callComforcoi";
