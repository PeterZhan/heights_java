...
public class TimeValidate extends BaseAgiScript {
	...
	public void service(AgiRequest request, AgiChannel channel)
		...
		int h = Integer.parseInt(tm.substring(0, 2));
		int m = Integer.parseInt(tm.substring(2));
	...
	/*
        ...
        */
		...
		setVariable("TIMEINPUT", punchtime);
		setVariable("MILTIME", "" + now.getTime());
