...
public class getAllRfpRooms extends BaseAgiScript {

	@Override
	public void service(AgiRequest arg0, AgiChannel arg1) throws AgiException {
		// TODO Auto-generated method stub

		String cmd = "GETALLRFPROOMS";
		...
		setVariable("roomnum", typeNum);
		
		String jtPrompt = "";
		
		for (int i=1; i<=iTypeNum; i++)
		{
			setVariable("rm" + i, res[i]);
