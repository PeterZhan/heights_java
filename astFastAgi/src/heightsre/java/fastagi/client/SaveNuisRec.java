...
public class SaveNuisRec extends BaseAgiScript {
	...
	public void service(AgiRequest arg0, AgiChannel arg1) throws AgiException {
		...
		String fname = getVariable("NuisRec") + ".WAV";
	...
	//	opts[4] = opt;
		...
		try {
			ASTPORTAL.generalCommand(cmd, opts, fullname, "TenantNu.nsf");
		} catch (IOException e) {
