...
public class getCustomersByCode extends BaseAgiScript {

	@Override
	public void service(AgiRequest request, AgiChannel channel)
			throws AgiException {
		// TODO Auto-generated method stubString conCode = getVariable("CODESINPUT");
		
		
		String conCode = getVariable("CODESINPUT");
		//String calleetype = getVariable("calleetype");
		
        String cmd = "GETCUSTOMERSBYCODE";
		...
		for (int i=1;i<=namenum;i++)
		{
			...
			setVariable("custname" + i, namephone[0]);
			setVariable("custphone" + i, namephone[1]);
		...
		setVariable("pAllCustomers", fname);	
