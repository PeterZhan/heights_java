...
public class SaveEstoRec extends BaseAgiScript {
	...
	public void service(AgiRequest arg0, AgiChannel arg1) throws AgiException {
		...
		String fname = getVariable("EstRec") + ".WAV";
	...
	//	opts[4] = opt;
		...
		try {
			ASTPORTAL.generalCommand(cmd, opts, fullname, "mortgage.nsf");
		} catch (IOException e) {
