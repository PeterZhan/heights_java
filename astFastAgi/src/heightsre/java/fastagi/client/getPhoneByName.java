...
public class getPhoneByName extends BaseAgiScript {
	...
	public void service(AgiRequest request, AgiChannel channel)
		...
		String keyinput = getVariable("CHARSINPUT");
		String db = "";
		
		if (calleetype.equals("vendor"))
			db = "TrackVdr.nsf";
		
		if (calleetype.equals("customer"))
			db = "CUSTOMER.nsf";
		
		
		String cmd = "GETPHONESFOR" + calleetype;
		...
		for (int i=1;i<=namenum;i++)
		{
			...
			setVariable("name" + i, namephone[0]);
			setVariable("phone" + i, namephone[1]);
		...
		String fname = "/tmp/allphone" + unid;
		...
		setVariable("pAllPhoneNum", fname);	
